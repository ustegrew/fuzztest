...
namespace fuzztest._dev_concepts.grammar.build {
    ...
    export class TDevBuildGrammar_02 {
        ...
        public static TestBuild() {
            let str : fuzztest.generator.rule.TStrategy;
            ...
            r = new fuzztest.generator.rule.rule.TRule("start");
...
namespace fuzztest.generator.rule.sequence {
    ...
    export class TSequence extends fuzztest.generator.rule.VNode {
        ...
        private fElements : fuzztest.utils.storage.TArrayList<fuzztest.generator.rule.VNode>;
...
namespace fuzztest.generator.rule.choice {
    ...
    export class TChoice extends fuzztest.generator.rule.VNode {
        ...
        private fBranches : fuzztest.utils.storage.TArrayList<fuzztest.generator.rule.VNode>;
