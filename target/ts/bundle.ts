...
fuzztest._dev_concepts.grammar.build.TDevBuildGrammar_02.TestBuild();         }     }     TMain["__classname"] = "fuzztest.TMain";  } 
...
let s : fuzztest.generator.rule._common.TAttributeSet;             
...
new fuzztest.generator.rule._common.TAttributeSet(null, 9, fuzztest.generator.rule._common.ERuleAdhesion.kFollowRule, 9, false));             
...
new fuzztest.generator.rule._common.TAttributeSet(null, 9, fuzztest.generator.rule._common.ERuleAdhesion.kInjectInvalids, 9, false));             
...
console.log(s0);             
console.log(s1);         }     }     TDevBuildGrammar_01["__classname"] = "fuzztest._dev_concepts.grammar.build.TDevBuildGrammar_01";  } 
...
let str : fuzztest.generator.rule._common.TAttributeSet;             
...
x = g.CreateData("");                 
console.log(x);             }         }     }     TDevBuildGrammar_02["__classname"] = "fuzztest._dev_concepts.grammar.build.TDevBuildGrammar_02";  } 
...
console.log(b);             }         }     }     TDevRnd_02["__classname"] = "fuzztest._dev_concepts.math.rnd.TDevRnd_02";  } 
 ...
 */
public static Get(key? : any) : any {             if(((typeof key === 'string') || key === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
 ...
 */
public static GetKeys(c? : any, isStrict? : any) : any {             if(((c != null && c instanceof fuzztest.model.abstracts.TClass) || c === null) && ((typeof isStrict === 'boolean') || isStrict === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     

let ret : fuzztest.utils.storage.TArrayList<string>;                     

ret = TRepository.gRepository_$LI$()._GetKeys(c, isStrict);                     

return ret;                 })();             } else if(((c != null && c instanceof fuzztest.model.abstracts.TClass) || c === null) && isStrict === undefined) {                 return <any>fuzztest.generator.TRepository.GetKeys$fuzztest_model_abstracts_TClass(c);             } else throw new Error('invalid overload');         }          
...
public _GetElement(key? : any) : any {             if(((typeof key === 'string') || key === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
...
/* Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org */ namespace fuzztest.generator.rule._common {     
...
key : string, 
recursionMax : number, 
ruleAdhesion : fuzztest.generator.rule._common.ERuleAdhesion, 
repeatMax : number, 
doNotRegister : boolean) {             

;             this.fDoNotRegister = false;             this.fRecursionCounter = 0;             this.fRecursionMax = 0;             this.fRepeatMax = 0;             
...
{                 
throw new RangeError("repeatMax out of range. Allowed: [0, " + TAttributeSet.kRepeatLimit + "], Given: " + repeatMax);             }         }     }     TAttributeSet["__classname"] = "fuzztest.generator.rule._common.TAttributeSet";  } 
...
public abstract GetChar(s : fuzztest.generator.rule._common.TAttributeSet) : string;     }     VCharSet["__classname"] = "fuzztest.generator.rule.cClass.VCharSet";  } 
...
/* Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org */ namespace fuzztest.model.abstracts {     
...
public GetInheritPath(isDetailed? : any) : any {             if(((typeof isDetailed === 'boolean') || isDetailed === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
...
return ret;         }     }     TClass["__classname"] = "fuzztest.model.abstracts.TClass";  } 
...
public GetAsString(isDetailed? : any) : any {             if(((typeof isDetailed === 'boolean') || isDetailed === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
...
return ret;         }     }     TInheritChain["__classname"] = "fuzztest.model.abstracts.TInheritChain";  } 
...
x = this._GetDouble();                 
x = min + x * (xMax - min);                 
ret = (<number>Math.floor(x)|0);             } else 
...
/* Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org */ namespace fuzztest.utils.storage {     
...
this.fNumElements = 0;         }     }     TArrayList["__classname"] = "fuzztest.utils.storage.TArrayList";  } 
...
public Get(key? : any) : any {             if(((typeof key === 'string') || key === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
...
return ret;         }     }     TArrayMap["__classname"] = "fuzztest.utils.storage.TArrayMap";  } 
...
this.fNumElements = 0;         }     }     THashMap["__classname"] = "fuzztest.utils.storage.THashMap";  } 
...
return this.fElement;         }     }     TOnceAssignable["__classname"] = "fuzztest.utils.storage.TOnceAssignable";  } 
 ...
 */
public _Register(key? : any) : any {             if(((typeof key === 'string') || key === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     

this._Register0(key);                 })();             } else if(key === undefined) {                 return <any>this._Register$();             } else throw new Error('invalid overload');         }          
...
fuzztest.generator.TRepository.Add(this);         }     }     VBrowseable["__classname"] = "fuzztest.generator.VBrowseable";       export namespace VBrowseable {          /**
 ...
 */export class VBrowseableT extends fuzztest.generator.VBrowseable {        }         VBrowseableT["__classname"] = "fuzztest.generator.VBrowseable.VBrowseableT";      }  } 
 ...
 */
public static GetChar(loChar? : any, hiChar? : any) : any {             if(((typeof loChar === 'string') || loChar === null) && ((typeof hiChar === 'string') || hiChar === null)) {                 let __args = Array.prototype.slice.call(arguments);                 return <any>(() => {                     
...
if(r === fuzztest.generator.rule._common.ERuleAdhesion.kFollowOpposite) 
{                 
ret = false;             } else 
...
{                 
this.fNumVisits++;                 
ret = this._CreateData(head);             } else 
...
constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }              
_CreateData(head : string) : string {                 return null;             }         }         VDeriv_02["__classname"] = "fuzztest._dev_concepts.objects.construct.from_abstract_class.trial_01.TDevCreateObject_02.VDeriv_02";      }  } 
...
{                 
console.log("found 0 (zero) keys.");             }         }     }     TDevQueryObject_01["__classname"] = "fuzztest._dev_concepts.objects.construct.from_abstract_class.trial_01.TDevQueryObject_01";       export namespace TDevQueryObject_01 {          export class VNodeType01 extends fuzztest.generator.rule._common.VNode {             constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }              _CreateData(head : string) : string {                 return null;             }         }         VNodeType01["__classname"] = "fuzztest._dev_concepts.objects.construct.from_abstract_class.trial_01.TDevQueryObject_01.VNodeType01";           export class VNodeType02 extends fuzztest.generator.rule._common.VNode {             constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }              _CreateData(head : string) : string {                 return null;             }         }         VNodeType02["__classname"] = "fuzztest._dev_concepts.objects.construct.from_abstract_class.trial_01.TDevQueryObject_01.VNodeType02";      }  } 
...
/* Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org */ namespace fuzztest._dev_concepts.objects.repo.del {     
...
console.log("=========================================================");             
console.log(typeof n1);         }     }     TDevRepoDel_01["__classname"] = "fuzztest._dev_concepts.objects.repo.del.TDevRepoDel_01";       export namespace TDevRepoDel_01 {          
...
constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }              
_CreateData(head : string) : string {                 return null;             }         }         VNodeType["__classname"] = "fuzztest._dev_concepts.objects.repo.del.TDevRepoDel_01.VNodeType";      }  } 
...
return ret;         }     }     VNodePassthrough["__classname"] = "fuzztest.generator.rule._common.VNodePassthrough";       export namespace VNodePassthrough {          export class VNodePassthroughT extends fuzztest.generator.rule._common.VNodePassthrough {             constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }         }         VNodePassthroughT["__classname"] = "fuzztest.generator.rule._common.VNodePassthrough.VNodePassthroughT";      }  } 
...
super(attributes);         }     }     VNodeProcessor["__classname"] = "fuzztest.generator.rule._common.VNodeProcessor";       export namespace VNodeProcessor {          export class VNodeProcessorT extends fuzztest.generator.rule._common.VNodeProcessor {             constructor() {                 super(fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }              _CreateData(head : string) : string {                 return null;             }         }         VNodeProcessorT["__classname"] = "fuzztest.generator.rule._common.VNodeProcessor.VNodeProcessorT";      }  } 
...
super(attributes);         }     }     TAction["__classname"] = "fuzztest.generator.rule.action.TAction";  } 
...
super(attributes);         }     }     TExpression["__classname"] = "fuzztest.generator.rule.expression.TExpression";  } 
...
super(attributes);         }     }     TGroup["__classname"] = "fuzztest.generator.rule.group.TGroup";  } 
...
super(attributes);         }     }     TInitializer["__classname"] = "fuzztest.generator.rule.initializer.TInitializer";  } 
...
super(attributes);         }     }     TSimpleAnd["__classname"] = "fuzztest.generator.rule.prefixed.simple_and.TSimpleAnd";  } 
...
super(attributes);         }     }     TSimpleNot["__classname"] = "fuzztest.generator.rule.prefixed.simple_not.TSimpleNot";  } 
...
super(attributes);         }     }     TText["__classname"] = "fuzztest.generator.rule.prefixed.text.TText";  } 
...
super(attributes);         }     }     TReference["__classname"] = "fuzztest.generator.rule.rule_ref.TReference";  } 
...
super(attributes);         }     }     TSemanticAnd["__classname"] = "fuzztest.generator.rule.semanticPredicate.semantic_and.TSemanticAnd";  } 
...
super(attributes);         }     }     TSemanticNot["__classname"] = "fuzztest.generator.rule.semanticPredicate.semantic_not.TSemanticNot";  } 
...
super(attributes);             this.fIsNMinZero = false;             this.fIsNMaxInfinite = false;             
...
return ret;         }     }     VSuffixed["__classname"] = "fuzztest.generator.rule.suffixed.VSuffixed";       export namespace VSuffixed {          /**
 * A dummy class to provide a concrete derivative from the hosting abstract class.
 * Purely needed so we have something to instantiate (TClass cTor needs an object).
 */export class VSuffixedT extends fuzztest.generator.rule.suffixed.VSuffixed {             constructor() {                 super(false, false, fuzztest.generator.rule._common.TAttributeSet.GetNullSet());             }         }         VSuffixedT["__classname"] = "fuzztest.generator.rule.suffixed.VSuffixed.VSuffixedT";      }  } 
...
super(false, true, attributes);         }     }     TOneOrMore["__classname"] = "fuzztest.generator.rule.suffixed.one_or_more.TOneOrMore";  } 
...
super(true, false, attributes);         }     }     TOptional["__classname"] = "fuzztest.generator.rule.suffixed.optional.TOptional";  } 
...
super(true, true, attributes);         }     }     TZeroOrMore["__classname"] = "fuzztest.generator.rule.suffixed.zero_or_more.TZeroOrMore";  } 
