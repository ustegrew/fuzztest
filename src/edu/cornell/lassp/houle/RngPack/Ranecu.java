...
public class Ranecu extends RandomSeedable
{
    ...
    /**
     *
     * Initialize <BOLD>RANECU</BOLD> with the default seeds from James.
     *
     */
    public Ranecu ()
    {
    ...
    /*
     *
     * Initialize <TT>RANECU</TT> from the clock without saving a copy of the
     * seed. Example:
     *
     * <PRE> RandomElement e = new Ranecu(new Date()); </PRE>
     *
