...
public class Ranlux extends RandomSeedable
{
     ...
     *
     * @param lux
     *            <A HREF="#luxury">luxury level</A> from 0-4.
     * @param ins
    ...
    private void init_arrays ()
    {
        ...
        /*
         *
         * converted from fortran: fortran arrays start at 1, java arrays start
         * at 0. Here we take the low road to compatibility... We declare arrays
         * that are one bigger than the fortran code. This wastes three ints and
         * a double; If you're porting this to a Commodore 64 you might need the
         * space.
         *
         */
