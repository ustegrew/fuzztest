 ...
 * 
 * 2016-10-21, PH: Beautified version, for fuzztest development.
 */

{
   
    /* 
     * PH:  Inlined all constants and functions in the initializer 
     *      so I can understand the code more easily.
