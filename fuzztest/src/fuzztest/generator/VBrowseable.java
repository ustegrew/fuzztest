...
public abstract class VBrowseable
{
    ...
    /**
     * Sets the key assigned to this object.
     * 
     * @param key       The key to be assigned.
     * @param doAuto    If <code>true</code>, generate a key. This will ignore the 
     *                  <code>key</code> parameter. If <code>false</code>, assign the
     *                  value of the given <code>key</code>.
     */
    private void _SetKey (String key, boolean doAuto)
    {
        if (fKey != null)
        {
